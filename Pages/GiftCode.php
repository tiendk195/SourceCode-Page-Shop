                    ...
                    <tbody class="dark:bg-slate-800">
                        ...
                        ?>
                          ...
                          <tr>
                            ...
                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400"> <?=$row['code'];?> </td>
                        ...
                        <span><?=$row['luotdung'];?> / <?=$row['gioihan'];?></span>
                      </div></td>
                            
                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400"> <?php if($row['loai'] == 'tien'){ echo Monney($row['amount']).'<sup>đ</sup>'; } else if($row['loai'] == 'phantram'){ echo $row['amount'].'%'; }; ?> </td>
                          </tr>
